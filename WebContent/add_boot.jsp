...
<div class="container">
	<div class="row">
		<div class="col-sm-12">
			<ul class="list-group">
				<li class="list-group-item"><a href="add_sass.jsp">sass</a></li>
				<li class="list-group-item"><a href="add_css.jsp">css기초</a></li>
				<li class="list-group-item active"><a href="add_boot.jsp">부트스트랩 익히기</a></li>
			</ul>
		</div>
	</div>
</div>
<div class="container">
	<div class="row">
		<div class="embed-responsive embed-responsive-16by9 col-md-12">
			<iframe class="embed-responsive" src="https://www.youtube.com/embed/QTLLxMMgEvg">
			</iframe>
		</div>
	</div>
</div>
